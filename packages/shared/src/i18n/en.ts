...
export const en = {
  ...
  allowance: {
    title: 'Allowance',
    hint: 'Decide what a coin is worth, see what each child has and what you owe, then pay it.',
    rateLabel: 'Coins per %{currency}',
    saveRate: 'Save rate',
    saving: 'Saving…',
    rateSaved: 'Rate saved.',
    rateFailed: 'Could not save the rate.',
    rateInvalid: 'Enter a whole number above zero.',
    balance: '%{coins} coins',
    owed: 'Owes %{amount}',
    ...
    payoutTooMuch: 'That is more than %{name} has.',
    adjustCoins: 'Coins to add or remove (use − for less)',
    adjustNote: 'Note',
    adjust: 'Record adjustment',
    adjustFailed: 'Could not record the adjustment.',
    adjustInvalid: 'Enter whole coins that are not zero, plus a note.',
    loadFailed: 'Could not load the allowance.',
    lockedTitle: 'Allowance is Premium',
    lockedHint:
      'Turn coins into allowance, adjustments and payouts. Premium unlocks it for the whole household.',
    lockedAction: 'See Premium · from $6.99/month',
  },
  notifications: {
    channel: 'Reminders',
  },
